      ...
      <div class="row">
        <div class="col-12">
          <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0 font-size-18">Custom Design</h4>
        ...
        <div class="col-xl-12">
          <div class="card">
            <div class="card-body">
              ...
              <a class="btn btn-soft-primary waves-effect waves-light mb-2" href="{{ route('custom_designs.create') }}">
                + Create New Custom Design </a>
              ...
              <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>{{ $custom_design->subtitle }}</td>
                    <td>{!! $custom_design->description !!}</td>
                    <td>
                      @if ($custom_design->image)
                      <img src="{{ asset('uploads/custom_designs/' . $custom_design->image) }}" alt="{{ $custom_design->title }}" width="80">
                      @else
                      No Image
                      @endif
                    </td>
                    ...
                    <td>
                      ...
                      <a class="btn btn-success waves-effect btn-circle waves-light"
                        href="{{ route('custom_designs.inactive', $custom_design->id) }}">
                        <i class="fas fa-check"></i> </a>
                      @else
                      <a class="btn btn-danger waves-effect btn-circle waves-light"
                        href="{{ route('custom_designs.active', $custom_design->id) }}">
                      ...
                      <form hidden action="{{ route('custom_designs.destroy', $custom_design->id) }}" id="form{{ $custom_design->id }}"
                        method="get">
                        @csrf
                      </form>
                    ...
                    {{-- <td>
                                            <a href="{{ route('custom_designs.edit', $custom_design->id) }}" class="btn btn-sm
                    btn-warning">Edit</a>
                    <form action="{{ route('custom_designs.destroy', $custom_design->id) }}" method="POST" style="display: inline-block;">
                      @csrf
                      @method('DELETE')
                      <button type="submit" class="btn btn-sm btn-danger"
                        onclick="return confirm('Are you sure you want to delete this custom_design?')">Delete</button>
                    </form>
                    </td> --}}
                  </tr>
                  @endforeach
