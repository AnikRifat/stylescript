                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <form class="row g-3" action="{{ route('courses.store') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="price" name="price" placeholder="99.00" required>
                                        </div>
