<div class="col-12 col-xl-3 col-lg-4 col-md-6 col-sm-12">
    <div class="card rounded-3 shadow">
        <div class="position-relative">
            ...
            <img class="card-img-top rounded-8" src="{{ asset('/uploads/courses/' . $course->image) }}" alt="{{ $course->title }}">
        </div>
        <div class="position-absolute top-0 end-0 m-3">
            <div class="dropdown">
                <button class="btn btn-light shadow-none dropdown-toggle" type="button" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
