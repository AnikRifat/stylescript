                ...
                <div class="py-30 px-30">
                    <div class="y-gap-30">
                        ...
                        <div class="d-flex justify-between">
                            ...
                            <a href="{{ route('chat.show.customer',$item->id) }}">
                    ...
                    <div class="row y-gap-20">
                        ...
                        <div class="col-xl-7 offset-xl-5 col-lg-10 offset-lg-2">
                            <div class="d-flex items-center justify-end">
                                ...
                                <div class="shrink-0">
                                    <img src="{{ asset('uploads/customers/'.Auth::user()->customer->image) }}"
                                      alt="image" class="size-50">
                                </div>
                            </div>
                            <div class="d-block mt-15">
                        ...
                        {{-- @else<div class="col-xl-7 col-lg-10">
                            <div class="d-flex items-center">
                                <div class="shrink-0">
                                    @php
                                    $customer = App\Models\User::find($chat->sender_id);

                                    @endphp <img src="{{ asset('') }}uploads/customers/{{ $customer->customer->image
                        }}"
                        alt="image" class="size-50">
                    </div>
                    <div class="lh-11 fw-500 text-dark-1 ml-10">{{ $customer->name }}</div>
                    <div class="text-14 lh-11 ml-10">{{ $chat->created_at->format('d M h:i:a') }}</div>
                </div>
                <div class="d-block mt-15">
                    <div class="py-20 px-30 bg-light-3 rounded-8">
