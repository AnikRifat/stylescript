    ...
    <div class="shop-single-product__content">
        ...
        <div class="shop-single-product__social">
            ...
            <a href="#" class="facebook" data-bs-tooltip="tooltip" data-bs-placement="top" title=""
              data-bs-original-title="Facebook" aria-label="Facebook"><i class="fab fa-facebook-f"></i></a>
            <a href="#" class="linkedin" data-bs-tooltip="tooltip" data-bs-placement="top" title=""
              data-bs-original-title="Linkedin" aria-label="Linkedin"><i class="fab fa-linkedin"></i></a>
            <a href="#" class="tumblr" data-bs-tooltip="tooltip" data-bs-placement="top" title=""
              data-bs-original-title="Tumblr" aria-label="Tumblr"><i class="fab fa-tumblr-square"></i></a>
            ...
            <div class="shop-product-tabs__item mt-6">
                <ul class="comment-list">
                    <li>
                        ...
                        <div class="comment-item">
                            <div class="comment-item__author">
                                <img src="{{ asset('') }}assets/web/images/avatar/avatar-02.jpg" alt="Avatar" width="70"
                                  height="70">
                            </div>
                    ...
                    <li>
                        ...
                        <div class="comment-item">
                            <div class="comment-item__author">
                                <img src="{{ asset('') }}assets/web/images/avatar/avatar-03.jpg" alt="Avatar" width="70"
                                  height="70">
                            </div>
                            <div class="comment-item__content">
                                <div class="comment-item__meta">
                    ...
                    <li>
                        ...
                        <div class="comment-item">
                            <div class="comment-item__author">
                                <img src="{{ asset('') }}assets/web/images/avatar/avatar-04.jpg" alt="Avatar" width="70"
                                  height="70">
                            </div>
                            <div class="comment-item__content">
                                <div class="comment-item__meta">
