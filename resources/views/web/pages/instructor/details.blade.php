        ...
        <div class="container">
            ...
            <div class="page-breadcrumb">
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">{{ $instructor->name }}</li>
                </ul>
            </div>
            <!-- Page Breadcrumb End -->
            ...
            <div class="page-banner__caption text-center">
                <h2 class="page-banner__main-title">{{ $instructor->name }}</h2>
            </div>
                    ...
                    <div class="course-header">
                        <div class="course-header__thumbnail ">
                            <a href="{{ route('course.details',$item->id) }}"><img
                                  src="{{ asset('') }}uploads/courses/{{ $item->image }}" alt="courses" width="258"
                                  height="173"></a>
                        </div>
                    </div>
